...
pub fn init(
    ...
    _ = ImGui_ImplSDL3_InitForOpenGL(window, gl_context);
...
pub fn processEvent(event: *const anyopaque) bool {
    return ImGui_ImplSDL3_ProcessEvent(@ptrCast(event));
}
...
extern fn ImGui_ImplSDL3_InitForOpenGL(window: *const anyopaque, gl_context: *const anyopaque) bool;
extern fn ImGui_ImplSDL3_Shutdown() void;
extern fn ImGui_ImplSDL3_NewFrame() void;
extern fn ImGui_ImplSDL3_ProcessEvent(data: *const anyopaque) bool;
